# Brunch Static Site + Wasmer

This example shows how to build a **Brunch** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` defines the build command for the Brunch example.
...
1. Build the site: `npm run build` (creates `public/`).
