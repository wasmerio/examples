# Create React App Static Site + Wasmer

This example shows how to build a **Create React App** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes React and `react-scripts`.
