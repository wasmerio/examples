# Ember Static Site + Wasmer

This example shows how to build a **Ember** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Ember CLI dependencies.
