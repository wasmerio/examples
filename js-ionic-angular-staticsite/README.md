# Ionic Angular Static Site + Wasmer

This example shows how to build a **Ionic Angular** static site and host the generated output on **Wasmer Edge**.
...
* `angular.json` and `package.json` describe the Ionic Angular project shape.
