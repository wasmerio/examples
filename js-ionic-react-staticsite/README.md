# Ionic React Static Site + Wasmer

This example shows how to build a **Ionic React** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Ionic React, React Router, and Vite dependencies.
