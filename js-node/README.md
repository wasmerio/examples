# Node.js HTTP Server + Wasmer

This example shows how to run **Node.js** on **Wasmer Edge** as an HTTP server.
...
* `server.js` uses Node's built-in `http` module and listens on `process.env.PORT`.
