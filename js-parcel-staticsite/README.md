# Parcel Static Site + Wasmer

This example shows how to build a **Parcel** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Parcel as the build tool.
