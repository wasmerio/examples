# Preact Static Site + Wasmer

This example shows how to build a **Preact** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Preact CLI and runtime packages.
