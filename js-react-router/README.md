...
This example shows how to run **React Router** on **Wasmer Edge** as an HTTP server.
...
* `package.json` includes the React Router server packages used by the template.
