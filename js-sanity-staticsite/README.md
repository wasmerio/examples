# Sanity Static Site + Wasmer

This example shows how to build a **Sanity** static site and host the generated output on **Wasmer Edge**.
...
* `sanity.config.ts` defines the Sanity project metadata.
