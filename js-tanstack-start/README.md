# TanStack Start + Wasmer

This example shows how to run **TanStack Start** on **Wasmer Edge** as an HTTP server.
...
* `package.json` includes TanStack Start, Router plugin, React, and React DOM.
