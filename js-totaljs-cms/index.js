...
// Run as a single foreground process (Total.js "release" mode). Without this,
// the default debug launcher forks a detached worker and the supervisor exits,
// which is incompatible with single-process hosts such as Wasmer Edge and the
// framework-test harness. The port is taken from the PORT environment variable.
