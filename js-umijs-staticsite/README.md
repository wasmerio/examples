# UmiJS Static Site + Wasmer

This example shows how to build a **UmiJS** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Umi as the build framework.
