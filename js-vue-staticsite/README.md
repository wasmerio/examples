# Vue Static Site + Wasmer

This example shows how to build a **Vue** static site and host the generated output on **Wasmer Edge**.
...
* `package.json` includes Vue CLI dependencies.
